...
PlasmaCore.ToolTipArea {
    ...
    KSvg.FrameSvgItem {
        ...
        anchors {
            ...
            // Don't add top/bottom icon margin for launchers — they span all rows
        ...
        states: [
            ...
            State {
                ...
                PropertyChanges {
                    ...
                    // For full-height launchers, size the icon from the task's own
                    // width (= tasksRoot.height) rather than taskList.minimumWidth,
                    // which could be narrower if regular tasks are small.
